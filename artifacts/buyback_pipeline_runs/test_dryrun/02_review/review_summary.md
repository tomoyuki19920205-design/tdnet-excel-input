...
| 項目 | 値 |
|:---|:---|
| 実行時刻 | 2026-03-11 16:36:41 JST |
| input_dir | c:\Users\takuy\OneDrive\tdnet-excel-input\data\docs |
| recursive | False |
| min_confidence | 0.6 |
| manifest | `c:\Users\takuy\OneDrive\tdnet-excel-input\artifacts\buyback_pipeline_runs\test_dryrun\01_candidates\candidate_manifest.csv` |
| manifest 行数 | 3 |
| manifest 解決成功 | 3 |
| manifest 解決失敗 | 0 |
